...
namespace TData.Tests
{
    public class InMemoryCacheTests
    {
        ...
        public void Initialize()
        {
            ...
            DbCacheConfig.Register(new DbSettings("db1", DbProvider.SqlServer, ConnectionString), new CacheSettings(DbCacheProvider.InMemory, false, null, null) { TTL = TimeSpan.FromMinutes(5) });
