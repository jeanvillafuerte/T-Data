...
namespace Thomas.Database.Tests.SQLite
{
    public class SQLiteTests : IDatabaseProvider
    {
        ...
        public void Initialize()
        {
            ...
            DbConfigurationFactory.Register(new DbSettings("db1", SqlProvider.Sqlite, ConnectionString));
        }
        ...
        public void InsertDataAndReturnNewId()
        {
            ...
            var id = dbContext.Add<User, int>(new User(0, 3, "Jean", true, 1340.5m, new DateTime(1997, 3, 21), Guid.NewGuid(), icon));
